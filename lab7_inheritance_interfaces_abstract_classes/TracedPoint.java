...
public class TracedPoint extends Point 
{
	...
	{
		super (x, y); // using x, y from Point
		System.out.println(x + y); 
	}
	// Your move method goes here.
	public void move (int x, int y)
	{
		TracedPoint temp = new TracedPoint(super.x, super.y); 
	
		System.out.println("point moved from ( " + temp.x + "," + temp.y + " to " + x + ", " + y + " )");
		super.x = x; 
		super.y = y; 
		// TracedPoint temp2 = new TracedPoint(x, y);
